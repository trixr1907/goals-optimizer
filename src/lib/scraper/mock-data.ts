...
export const MOCK_PLAYERS: Player[] = [
  ...
  { id: '2', name: 'Davies', position: 'FB', overall: 87, rarity: 'Epic', stats: s(96, 60, 78, 85, 72, 70), roleRatings: [{ position: 'FB', overall: 87 }], secondaryPositions: [] },
  ...
  { id: '5', name: 'Kimmich', position: 'FB', overall: 88, rarity: 'Epic', stats: s(70, 68, 88, 80, 78, 72), roleRatings: [{ position: 'FB', overall: 88 }], secondaryPositions: [] },
  ...
  { id: '8', name: 'Sané', position: 'WF', overall: 86, rarity: 'Epic', stats: s(93, 82, 78, 88, 35, 55), roleRatings: [{ position: 'WF', overall: 86 }], secondaryPositions: [] },
